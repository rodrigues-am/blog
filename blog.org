...
:PROPERTIES:
:EXPORT_FILE_NAME: eua-joelhos
:EXPORT_DATE: 2026-04-07T22:28:58-0300
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :comments true
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :cover '((image . "/img/eua-joelho.png"))
:END:
...
O Trump que, na eleição, venceu o Colégio Eleitoral, a maioria dos votos, o Senado e a Câmara [fn:3], vê, com essa guerra, uma rápida corrosão de qualquer movimento popular [fn:4].
